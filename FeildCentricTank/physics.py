...
class PhysicsEngine:
    def __init__(self, physics_controller: PhysicsInterface, robot: "MyRobot"):
        ...
        # Motors
        self.l_motor = wpilib.simulation.PWMSim(robot.container.drive.left1.getChannel())
        self.r_motor = wpilib.simulation.PWMSim(robot.container.drive.right1.getChannel())
